  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <p>
          새로고침을 누르면 새로운 명언을 볼 수 있습니다.
        </p>
        {proverbs[getRandomIndex()]}
      </header>
    </div>
  );
}
